...
export default function init() {
  ...
  worley.texture = twgl.createFramebufferInfo(gl, attachments, width * TEX_SCALE_FACTOR, height * TEX_SCALE_FACTOR)
...
function render(gl, worley) {
  ...
  twgl.setUniforms(worley.programs.render, { tex: worley.texture.attachments[0], size: [width, height] })
